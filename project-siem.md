...
- une machine dite _machine d'administration_ ou [https://en.wikipedia.org/wiki/Jump_server](_jump server_) acceptant des connexions SSH et permettant d'administrer le serveur _Wazuh_ et _web_
